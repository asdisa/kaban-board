/**
 * Major pillar of application responsible for rendering state.
 * @extends Observer
 */
class View extends Observer {
   ...
   * to entityManager on `parentIndex` position then focuses added entity.
  ...
  /**
   * Board representation corresponding to `entityManager` with `index`.
   *
   * @param {TitledEntityManager} entityManager Parent entityManager
   * @param {?number} index Index of parent entityManager (null corresponds to the Wall)
   */
  ...
  /**
   * Renders application state into UI.
   *
